    ...
    return (
      <>
        ...
        <Navbar className="navBar" expand="lg" href="#home">
          <Navbar.Brand className="navBrand" href="/homepage">
            SIT Schedular 2.0
          </Navbar.Brand>
          <Navbar.Toggle aria-controls="basic-navbar-nav" />
          <Navbar.Collapse>
          ...
          <Row>
            ...
            <Col lg={12} md={12} sm={12}>
              <Card.Body>
                ...
                <Card.Text>Email ID: {userData.email}</Card.Text>

                <Card.Text>CWID: {userData.CWID}</Card.Text>
              </Card.Body>
            </Col>
          </Row>
        </Card>
